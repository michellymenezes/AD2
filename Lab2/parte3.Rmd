...
- Use ou tente melhorar o seu modelo para prever os dados de teste que disponibilizamos por meio da plataforma Kaggle: https://inclass.kaggle.com/c/previsao-do-cra-dos-alunos-de-computacao (Links para um site externo)
...
Utilizando a função *round* é fornecido que o RMSE obtido no modelo Ridge foi igual a 0.416. Ao interpretar o resultado da função entendemos que houve uma redução no valor do RMSE e, consequentemente, uma melhora no modelo.
