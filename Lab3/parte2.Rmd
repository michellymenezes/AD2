...
Aplicando meus dados pessoais nos dois melhores modelos, vemos que ambos acertam na predição. Tando a regressão logística quanto a árvore de decisão apontam para não evasão, que é a resposta esperada.

```{r}
pessoal.dados = data.frame(Introdução.à.Computação=8.4, Leitura.e.Produção.de.Textos = 8.2)
